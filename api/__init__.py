...
def create_app(env_name):
	...
	app.register_blueprint(cart_bp, url_prefix="/api/v1")  # Register the cart blueprint
	app.register_blueprint(order_bp, url_prefix="/api/v1")  # Register the order blueprint
